...
SliBheatha: "N/A"
  ...
  it('should test that if Topic is entered, it searches, fills correctly and ignores case', () => {
    component.profileForm.value.Topic = "LaoitheFiannaiochta";
    component.onSubmit();
